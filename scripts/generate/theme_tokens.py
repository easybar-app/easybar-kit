...
def render_swift_enum(tokens: list[dict]) -> str:
    ...
    lines = [
        "import Foundation",
        "",
        "// This file is generated by scripts/generate/theme_tokens.py. Do not edit by hand.",
...
def replace_generated_theme_section(base_text: str, generated: str) -> str:
    ...
    if count != 1:
        raise SystemExit(
            "could not find generated theme API insertion markers in easybar_api.base.lua")
...
def main() -> None:
    ...
    LUA_API_BASE_PATH.write_text(
        replace_generated_theme_section(base_text, generated_themes))
